...
//
/**
 * Declares ThrustSegmentRvector class which provides base class for environment realated
 * Real Parameters
 */
 //------------------------------------------------------------------------------
#ifndef ThrustSegmentRvector_hpp
#define ThrustSegmentRvector_hpp
...
class THRUSTFILE_API ThrustSegmentRvector : public RvectorVar, public ThrustSegmentData
{
   public:
...
#endif // ThrustSegmentRvector_hpp
