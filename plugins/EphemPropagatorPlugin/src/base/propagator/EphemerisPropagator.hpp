...
protected:
   ...
   GmatEpoch                  ephemEnd;
   /// Flag used to stop a run if the epoch is outside of the ephem span
   bool                       stopOutsideOfEphem;
   ...
   /// Flag set to ensure initialization from ephemeris file is completed
   bool						  initialEphemEpochSet;
