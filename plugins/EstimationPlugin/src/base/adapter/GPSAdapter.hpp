...
public:
   ...
   bool                 SetGPSReceiverName(const std::string name) { gpsReceiverName = name; return true; };
   std::string          GetGPSReceiverName() { return gpsReceiverName; };
