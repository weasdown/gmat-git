...
protected:
   ...
   Integer ap_yyyymmddMin;
   Integer ap_yyyymmddMax;

   /// epoch range specified by ig_rz.dat
   Integer igrz_yyyymmddMin;
   Integer igrz_yyyymmddMax;
