...
SignalData::SignalData() :
   ...
   tPrecTime            (21545.0),
   rPrecTime            (21545.0),
   tJ2kRotation         (true),                                         // Note that: Rmatrix33 B(true) is a constructor of Rmatrix33. It defines matrix B to be a 3x3 identity matrix
   rJ2kRotation         (true),                                         // Note that: Rmatrix33 B(true) is a constructor of Rmatrix33. It defines matrix B to be a 3x3 identity matrix

   tJ2kRotationDot      (false),                                         // Note that: Rmatrix33 B(false) is a constructor of Rmatrix33. It defines matrix B to be a 3x3 zero matrix
   rJ2kRotationDot      (false),                                         // Note that: Rmatrix33 B(false) is a constructor of Rmatrix33. It defines matrix B to be a 3x3 zero matrix
...
SignalData::SignalData(const SignalData& sd) :
   ...
   tJ2kRotationDot      (sd.tJ2kRotationDot),
   rJ2kRotationDot      (sd.rJ2kRotationDot),
   ...
   horpHeight           (sd.horpHeight),
   horpAngle            (sd.horpAngle),
   next                 (NULL)
{
}
