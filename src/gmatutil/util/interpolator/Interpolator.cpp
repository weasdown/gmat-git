...
//   GmatBase           (i),
   ...
   allowExtrapolation (i.allowExtrapolation),
...
//------------------------------------------------------------------------------
// void SetExtrapolation(bool flag)
//------------------------------------------------------------------------------
/*
 * Sets extrapolation flag.
 */
//------------------------------------------------------------------------------
void Interpolator::SetExtrapolation(bool flag)
{
   allowExtrapolation = flag;
}
