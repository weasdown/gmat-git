...
class GMATUTIL_API UtilityException : public BaseException
{
public:
...
class GMATUTIL_API GravityFileException : public BaseException
{
public:
...
class GMATUTIL_API TimeException : public BaseException
{
public:
