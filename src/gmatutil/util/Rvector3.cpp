...
//  static data
//---------------------------------
const Real Rvector3::UTIL_REAL_UNDEFINED = GmatRealConstants::REAL_UNDEFINED;
const Rvector3
   Rvector3::RVECTOR3_UNDEFINED = Rvector3(UTIL_REAL_UNDEFINED, UTIL_REAL_UNDEFINED,
   UTIL_REAL_UNDEFINED);
...
//------------------------------------------------------------------------------
Rvector3::Rvector3(const RealArray &ra)
   : Rvector(ra)
{
   // This check must be made here or the resulting Rvector3 may not
   // be of size 3!!
   if (ra.size() != 3)
