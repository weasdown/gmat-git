...
BrachistochroneDriver::BrachistochroneDriver(const std::string &testName, const Integer snoptConsoleOutputLevel) :
	CsaltTestDriver(testName, snoptConsoleOutputLevel)
{
}
