...
#include "ConwayOrbitExampleDriver.hpp"
...
ConwayOrbitExampleDriver::ConwayOrbitExampleDriver() :
      CsaltTestDriver("ConwayOrbitExample")
{
}
...
void ConwayOrbitExampleDriver::SetPointPathAndProperties()
{
...
void ConwayOrbitExampleDriver::SetupPhases()
{
   //Set mesh properties
