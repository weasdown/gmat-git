...
#include "RayleighControlStateConstraintDriver.hpp"
...
RayleighControlStateConstraintDriver::RayleighControlStateConstraintDriver() :
      CsaltTestDriver("RayleighControlStateConstraint")
{
}
...
void RayleighControlStateConstraintDriver::SetPointPathAndProperties()
{
   pathObject = new RayleighControlStateConstraintPathObject();
   pointObject = new RayleighControlStateConstraintPointObject();

   maxMeshRefinementCount = 50;
}

void RayleighControlStateConstraintDriver::SetupPhases()
{
   ...
   Rvector initialGuessState(2, -5.0, -5.0);
   Rvector finalGuessState(2, 0.0, 0.0);
