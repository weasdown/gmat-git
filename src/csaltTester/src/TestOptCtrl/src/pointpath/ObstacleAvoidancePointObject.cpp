...
ObstacleAvoidancePointObject::ObstacleAvoidancePointObject() :
   UserPointFunction()
{
}
...
// copy constructor
//------------------------------------------------------------------------------
ObstacleAvoidancePointObject::ObstacleAvoidancePointObject(const ObstacleAvoidancePointObject &copy) :
...
// operator=
//------------------------------------------------------------------------------
ObstacleAvoidancePointObject& ObstacleAvoidancePointObject::operator=(const ObstacleAvoidancePointObject &copy)
{
   if (&copy == this)
      return *this;
...
//-----------------------------------------------------------------------------
void ObstacleAvoidancePointObject::EvaluateFunctions()
{
   ...
   Rvector algFunctions(6, tInit, tFinal, stateInit(0), stateInit(1), stateFinal(0), 
                        stateFinal(1));
   Rvector algFuncLower(6, 0.0, 1.0, 0.0, 0.0, 1.2, 1.6);
   Rvector algFuncUpper(6, 0.0, 1.0, 0.0, 0.0, 1.2, 1.6);
...
//-----------------------------------------------------------------------------
void ObstacleAvoidancePointObject::EvaluateJacobians()
{
