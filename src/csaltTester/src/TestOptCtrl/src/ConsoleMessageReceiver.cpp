      ...
      bool append)
{
   ...
   if (logFile)
   {
      ...
      // Fix bug GMT-7399                                                             // made changes by TUAN NGUYEN
      //fprintf(logFile, "%s %s %s\n\n",  logFileStart.c_str(), __DATE__, __TIME__);  // made changes by TUAN NGUYEN
      fprintf(logFile, "%s %s %s\n\n", logFileStart.c_str(),                          // made changes by TUAN NGUYEN
         GmatGlobal::Instance()->GetGMATBuildDate().c_str(),                          // made changes by TUAN NGUYEN
         GmatGlobal::Instance()->GetGMATBuildTime().c_str());                         // made changes by TUAN NGUYEN
