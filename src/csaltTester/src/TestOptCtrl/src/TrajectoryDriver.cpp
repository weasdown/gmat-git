...
TrajectoryDriver::TrajectoryDriver()
{
...
Real TrajectoryDriver::GetMaxError(const Rvector &vec)
{
   Real max = -999.99;
...
Real TrajectoryDriver::GetMaxError(const Rmatrix &mat)
{
   Real max = -999.99;
   Integer r, c;
   mat.GetSize(r,c);
