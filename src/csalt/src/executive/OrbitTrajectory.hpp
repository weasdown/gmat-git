...
//
/**
* Declares the OrbitTrajectory class.
*/
//------------------------------------------------------------------------------
#ifndef OrbitTrajectory_hpp
#define OrbitTrajectory_hpp
...
class CSALT_API OrbitTrajectory : public Trajectory
{
public:
   OrbitTrajectory();
   OrbitTrajectory(const OrbitTrajectory &copy);
   OrbitTrajectory& operator=(const OrbitTrajectory &copy);
   virtual ~OrbitTrajectory();

   virtual void Initialize();
};
#endif // !OrbitTrajectory_hpp
