...
bool Inverse::ValidateInputs()
{
   ...
   if (type == Gmat::RMATRIX_TYPE && row != col)
      throw MathException("Cannot compute inverse of non-square matrix");

   if ((type == Gmat::REAL_TYPE) || (type == Gmat::RMATRIX_TYPE))
      return true;
