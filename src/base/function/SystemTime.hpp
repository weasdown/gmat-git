...
#ifndef SRC_BASE_FUNCTION_SystemTime_HPP_
#define SRC_BASE_FUNCTION_SystemTime_HPP_

#include "BuiltinGmatFunction.hpp"

class GMAT_API SystemTime : public BuiltinGmatFunction
{
public:
   SystemTime(const std::string &typeStr, const std::string &name);
   virtual ~SystemTime();
...
//   virtual void         SetOutputName(const std::string &outputName);
