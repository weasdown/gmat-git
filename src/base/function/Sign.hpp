...
#ifndef SRC_BASE_FUNCTION_SIGN_HPP_
#define SRC_BASE_FUNCTION_SIGN_HPP_

#include "BuiltinGmatFunction.hpp"

class GMAT_API Sign : public BuiltinGmatFunction
{
public:
   Sign(const std::string &typeStr, const std::string &name);
   virtual ~Sign();
   Sign(const Sign &f);
...
protected:
   ...
   ElementWrapper*      CreateOutputVariableWrapper(Real a1MjdEpoch, const std::string &outName);

};



#endif /* SRC_BASE_FUNCTION_SIGN_HPP_ */
