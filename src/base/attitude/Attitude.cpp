...
//-------------------------------------------------------------------------------------------------
// Rmatrix33 GetRotationMatrix(GmatTime &epochGT)
//-------------------------------------------------------------------------------------------------
/**
* Get rotation matrix from spacecraft's attitude frame (B-frame) to inertial frame (I-frame) at 
* a given time.
*
...
*/
//-------------------------------------------------------------------------------------------------
Rmatrix33 Attitude::GetRotationMatrix(const GmatTime &epochGT)
{
