...
public:
   ...
   virtual SpacePoint *    GetCentralBody();
...
protected:
   ...
   //virtual bool HasLocalClones() const;
   //virtual void RenameRefObject(const UnsignedInt, const std::string & name, const std::string &newName);
