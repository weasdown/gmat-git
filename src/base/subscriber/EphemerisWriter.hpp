...
protected:
   ...
   virtual void BufferOrbitData(Real epochInDays, const Real state[6], const Real cov[21], const Real accel[3]) = 0;
   ...
   virtual void WriteOrbit(Real reqEpochInSecs, const Real state[6], const Real cov[21], const Real accel[3]);
   //virtual void WriteOrbitAt(Real reqEpochInSecs, const Real state[6], const Real cov[21]); 
   virtual void WriteOrbitAt(Real reqEpochInSecs, const Real state[6], const Real cov[21], const Real accel[3]);
