function  [px, q, plam, flag, activeSet, iter] = miNLP_searchdir2(x,f,gradF,ce,ci,Je,Ji,A,b,...
    Aeq,beq,eqInd,ineqInd,Options,mLE,mLI,m,W,lagMult,activeSet,method)
...
if strcmp(Options.QPMethod,'minQP')
    ...
    if method == 1
        Options.Display = 0;
        [px, q, lambdaQP, flag, activeSet, iter] = MinQP(x, W, gradF, Aqp, bqp, eqInd,...
            ineqInd, [], Options, 2);
    elseif method == 2
        import MinQPClass
