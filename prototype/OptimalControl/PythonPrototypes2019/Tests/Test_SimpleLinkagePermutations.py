"""
Tester for seeing if the simple linkage constraint works with all sorts of different state representations
Revision log:
2018-12-10; Noble Hatten; Created
2019-03-01; Noble Hatten; Revising to add ephemSmoother stuff and Jacobian testing
"""
    ...
    for fConfig in fConfigs:
        ...
        for p1Config in pConfigs:
            ...
            for p2Config in pConfigs:
                ...
                jacValue = aLink.EvaluateJacobian()
                #if j==0 and k==1:
                #    print('****************************************************************')
