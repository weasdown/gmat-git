...
phase1.initialStateUpperBound    = [1 0 0 1 1]';
...
PathFunc  = traj.phaseList{1}.PathFunction;
PointFunc = traj.phaseList{1}.PointFunction;

nlpFuncs  = phase1.GetNLPFunctionValues(PathFunc,PointFunc)
userFuncs = phase1.GetUserFunctionValues(PathFunc,PointFunc)
