classdef AutoNGCLOSKInterface < exec.CSALTAPI
    ...
    methods
        ...
        function obj = AutoNGCLOSKInterface(cartState,initMassKg,sc,fm,fmMoon2body)
...
%             Isp = 200; % seconds
            ...
            traj.pointFunctionObject = AutoNGCLOSKPointObject();
            ...
            traj.maxMeshRefinementCount = 20;
            traj.maxMajorIterations = 30;
            ...
            traj.pointFunctionObject.SetFinalConditions(finalModEqElemsNonDim');
            ...
            timeLowerBound    = 0;
            timeUpperBound    = 1000; % probably can make this smaller, but starting with it large for now
            
            %  Set state bounds and guesses
            numStateVars      = 7;
            stateLowerBound   = [0 -.99 -.99 -100 -100 -100 1e-4]';
