classdef LISAPointObject_nhatten < userfunutils.UserPointFunction
    ...
    methods
        ...
        function EvaluateFunctions(obj)
            ...
            [norm(initCartStateConstraintValue), initTimeConstraintValue, finalTimeConstraintValue];
            
            % Set the boundary constraints
            obj.SetAlgFunctions([initCartStateConstraintValue; initTimeConstraintValue; finalTimeConstraintValue]);
